export const localimag = {
  ...
  mic: require("../icons/btn_recording.png"),
  ...
  purse: require("../icons/Path58733x.png"),
  //04-03 radhekrishan
  prescription: require("../icons/medical_prescription.png"),
  ...
  covid_test_banner: require("../icons/covid_test_banner.png"),
  covid_test_banner_ar: require("../icons/covid_test_banner_ar.png"),
