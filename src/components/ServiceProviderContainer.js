            ...
            <View
              ...
              </Text>
              {
                ...
                >
                  ...
                  >
                    {(providerType == 'nurse' || providerType == 'caregiver' || providerType == 'babysitter' || providerType == 'physiotherapy') ? LangProvider.BOOKAPPOINTMENT[languageIndex] : providerType === 'lab' ? LangProvider.BOOKTEST[languageIndex] : LangProvider.BookConsultation[languageIndex]}
                  </Text>
                </TouchableOpacity>
              }
            </View>
