...
import { dummyUser, Star, Location, Clock } from "../icons/SvgIcons/Index";
                ...
                >
                  {
                    (Item.image == "NA" || Item.image == null || Item.image == "") ?
                      <SvgXml xml={dummyUser} height={s(95)} width={s(95)} style={{ borderWidth: 1, borderRadius: 51, borderColor: Colors.Border, marginLeft: s(5) }} />
                      :
                      <Image
