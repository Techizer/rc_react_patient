                    ...
                    <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ width: '94%', }}>
                            <View style={{ width: '68%', flexDirection: 'row', justifyContent: 'space-between', alignItems:'center' }}>
                                <Text style={{ textAlign: config.textRotate, fontSize: Font.small, fontFamily: Font.Medium, color: Colors.darkText }}>{'Ramona Alba'}</Text>
                                <Text style={{ fontSize: 3.5, color: Colors.lightGrey }}>{'\u2B24'}</Text>
                                <Text style={{ textAlign: config.textRotate, fontSize: Font.small, fontFamily: Font.Medium, color: Colors.lightGrey }}>{'Male, 33 Years'}</Text>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: vs(10) }}>
                        <View style={{ width: '94%', flexDirection: 'row' }}>
                            <View style={{ flex: 1, borderEndWidth: 1, borderEndColor: Colors.Border }}>
                                ...
                                <Text style={{ textAlign: config.textRotate,fontSize: Font.medium, fontFamily: Font.Medium, marginTop: vs(4), color: Colors.detailTitles }}>{'10'}</Text>
                            </View>
